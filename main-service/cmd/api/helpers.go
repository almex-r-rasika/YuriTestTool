...
/* function for writes a json response to the client
   @param --> http.ResponseWriter, int, any, http.Header
   @param value --> w http.ResponseWriter, status int, data any, headers ...http.Header
   description --> writeJSON takes a response status code and arbitrary data and writes a json response to the client
   @return --> error
*/
